<div class="flex flex-col min-h-screen container mx-auto items-center w-full space-y-4 py-8">
    <form wire:submit="add" class="max-w-md w-full mx-auto">
        ...
        <div class="relative">
            <input wire:model="todo" type="text" id="default-input" class="block w-full p-4 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Add todos..." required />
